...
**“Automated Multi-OS EC2 Provisioning & Conditional Management using Ansible”**
...
* Executed from control node using: connection: local
...
* Gathered system facts using Ansible
* Applied condition: when: ansible_distribution == "Ubuntu"
